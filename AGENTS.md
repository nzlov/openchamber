...
| Live or remote OpenChamber debugging with headless browser login, protected runtime APIs, screenshots, DOM inspection, session/thread ids, or production-only UI/API discrepancies | `skill({ name: "online-runtime-debug" })` |
