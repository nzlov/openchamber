...
Install [Codex](https://openai.com/codex) first — OpenChamber runs on top of it.
...
Download the latest desktop build from the GitHub releases page or the OpenChamber download page. Open it and sign into your usual Codex workflow.

## VS Code

Install from the VS Code Marketplace and sign into your usual Codex workflow. The OpenChamber view then opens in the sidebar.
