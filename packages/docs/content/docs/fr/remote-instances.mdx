...
> Les instances distantes sont une fonctionnalité **desktop uniquement**. Sur le web ou dans VS Code, connectez-vous à un serveur distant avec les variables d’environnement de [Serveur Codex](/codex-server/) à la place.
...
- [Serveur Codex](/codex-server/) — se connecter à un serveur distant sur web ou VS Code
