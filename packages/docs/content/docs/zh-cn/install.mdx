...
请先安装 [Codex](https://openai.com/codex)——OpenChamber 在它之上运行。
...
从 GitHub 发布页或 OpenChamber 下载页下载最新的桌面版本。打开它，并登录你常用的 Codex 工作流。

## VS Code

从 VS Code Marketplace 安装，并登录你常用的 Codex 工作流。随后 OpenChamber 视图会在侧边栏中打开。
