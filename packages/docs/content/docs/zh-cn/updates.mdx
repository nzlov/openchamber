...
OpenChamber 和 Codex 分别更新。当有新的 Codex 版本可用时，OpenChamber 会提议更新它，并在之后重启服务器。关于该服务器如何被管理，请参阅 [Codex Runtime](/zh-cn/codex-server/)。

## 相关内容

- [安装](/zh-cn/install/) — 每个应用最初是如何安装的
- [Codex Runtime](/zh-cn/codex-server/) — 更新底层服务器
