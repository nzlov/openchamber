...
OpenChamber is the visual workspace around Codex (the AI coding agent that runs in your terminal). It gives you a screen to watch and steer that work, instead of living on the command line.
...
- [Providers, Models & Agents](/providers/) — connect Codex and pick a model
