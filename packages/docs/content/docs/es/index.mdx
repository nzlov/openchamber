...
OpenChamber es el espacio de trabajo visual en torno a Codex (el agente de programación con IA que se ejecuta en tu terminal). Te da una pantalla para observar y dirigir ese trabajo, en lugar de vivir en la línea de comandos.
...
- [Proveedores, modelos y agentes](/es/providers/) — conecta Codex y elige un modelo
