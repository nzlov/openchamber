...
OpenChamber와 Codex는 별도로 업데이트됩니다. 새 Codex 버전이 있으면 OpenChamber가 업데이트를 제안하고, 이후 서버를 재시작합니다. 그 서버가 관리되는 방식은 [Codex Runtime](/ko/codex-server/)를 참고하세요.

## 관련 항목

- [Install](/ko/install/) — 각 앱이 처음에 설치되는 방법
- [Codex Runtime](/ko/codex-server/) — 기반 서버 업데이트
