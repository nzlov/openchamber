---
title: Połączenie z Codex
description: Napraw brak połączenia OpenChamber z serwerem Codex.
---

# Połączenie z Codex

Jeśli OpenChamber się ładuje, ale nigdy nie przechodzi poza „Codex uruchamia się ponownie”, albo czat nie odpowiada, serwer, z którym się komunikuje, jest nieosiągalny. Przejdź przez te kroki.

## Utknął na „Codex uruchamia się ponownie”
...
Jeśli ustawiłeś OpenChamber tak, aby używał istniejącego serwera, sprawdź ponownie konfigurację z [Codex Runtime](/pl/codex-server/):
...
- [Codex Runtime](/pl/codex-server/) — jak OpenChamber znajduje serwer i nim zarządza
