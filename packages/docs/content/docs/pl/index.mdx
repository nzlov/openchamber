...
OpenChamber to wizualna przestrzeń pracy wokół Codex (agenta AI do programowania, który działa w terminalu). Daje Ci ekran, na którym możesz obserwować i kierować tą pracą, zamiast pozostawać w wierszu poleceń.
...
- [Dostawcy, modele i agenci](/pl/providers/) — połącz Codex i wybierz model
