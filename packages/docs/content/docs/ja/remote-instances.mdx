...
> リモートインスタンスは**デスクトップ専用**機能です。Web または VS Code では、代わりに [Codex サーバー](/codex-server/) の環境変数を使ってリモートサーバーに接続します。
...
- [Codex サーバー](/codex-server/) — Web または VS Code でリモートサーバーに接続する
