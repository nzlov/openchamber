...
OpenChamber と Codex は別々に更新されます。新しい Codex バージョンが利用可能な場合、OpenChamber は更新を提案し、その後サーバーを再起動します。そのサーバーの管理方法は [Codex サーバー](/codex-server/) を参照してください。

## 関連

- [インストール](/install/) — 各アプリのインストール方法
- [Codex サーバー](/codex-server/) — 下層サーバーの更新
