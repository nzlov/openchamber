...
先に [Codex](https://openai.com/codex) をインストールしてください。OpenChamber はその上で動作します。
...
GitHub releases ページまたは OpenChamber ダウンロードページから最新のデスクトップビルドをダウンロードします。開いたら、普段の Codex ワークフローにサインインします。

## VS Code

VS Code Marketplace からインストールし、普段の Codex ワークフローにサインインします。その後、OpenChamber ビューがサイドバーに開きます。
