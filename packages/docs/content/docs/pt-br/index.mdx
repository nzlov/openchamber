...
O OpenChamber é o espaço de trabalho visual em torno do Codex (o agente de programação com IA que roda no seu terminal). Ele te dá uma tela para acompanhar e direcionar esse trabalho, em vez de viver na linha de comando.
...
- [Provedores, Modelos e Agentes](/pt-br/providers/) — conecte o Codex e escolha um modelo
