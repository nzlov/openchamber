---
title: Codex Runtime
description: Conecte o OpenChamber a um servidor Codex local ou remoto.
---

# Codex Runtime

O OpenChamber roda sobre um servidor Codex. Por padrão, ele inicia um para você, então não precisa fazer nada. Você só precisa desta página se quiser apontar o OpenChamber para um servidor que já executa, ou gerenciar o que ele inicia.
...
Enquanto o servidor está iniciando ou reiniciando, o OpenChamber mostra um estado "Codex is restarting" e pausa as requisições até ele estar pronto. Isso é normal logo após a inicialização ou um reinício. Se nunca sair desse estado, veja [Conexão com o Codex](/pt-br/troubleshooting/codex-connection/).

## Relacionado

- [Provedores, Modelos e Agentes](/pt-br/providers/) — configure com o que o servidor conversa
- [Conexão com o Codex](/pt-br/troubleshooting/codex-connection/) — se ele não conectar
