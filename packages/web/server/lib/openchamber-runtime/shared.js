...
const CUSTOM_CONFIG_FILE = process.env.CODEX_CONFIG
  ? path.resolve(process.env.CODEX_CONFIG)
  : null;
...
function readConfigFile(filePath) {
  ...
  try {
    ...
    throw new Error('Failed to read Codex configuration');
  }
}
...
function writeConfig(config, filePath = CONFIG_FILE) {
  try {
    ...
    throw new Error('Failed to write Codex configuration');
  }
}
