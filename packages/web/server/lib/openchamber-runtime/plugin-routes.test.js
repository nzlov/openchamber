...
let rootDir;
let plugins;
let refreshRuntimeAfterConfigChange;
let app;
let cleanupPaths;
...
describe('Codex plugin routes', () => {
  ...
  beforeEach(() => {
    ...
    refreshRuntimeAfterConfigChange = mock(async () => undefined);
    cleanupPaths = [];
    app = createApp();
  });
  ...
  test('POST /entry creates entry and requires reload', async () => {
    ...
    expect(refreshRuntimeAfterConfigChange).toHaveBeenCalledWith('plugin entry creation');
  });
  ...
  test('PATCH /entry/:id updates entry in same array index', async () => {
    ...
    expect(refreshRuntimeAfterConfigChange).toHaveBeenCalledWith('plugin entry update');
  });
  ...
  test('DELETE /entry/:id removes entry and prunes plugin key', async () => {
    ...
    expect(refreshRuntimeAfterConfigChange).toHaveBeenCalledWith('plugin entry deletion');
  });
  ...
  test('POST /file writes plugin dir file', async () => {
    ...
    expect(refreshRuntimeAfterConfigChange).toHaveBeenCalledWith('plugin file creation');
  });
  ...
  test('PUT /file/:id updates file content', async () => {
    ...
    expect(refreshRuntimeAfterConfigChange).toHaveBeenCalledWith('plugin file update');
  });
  ...
  test('DELETE /file/:id unlinks file', async () => {
    ...
    expect(refreshRuntimeAfterConfigChange).toHaveBeenCalledWith('plugin file deletion');
  });
