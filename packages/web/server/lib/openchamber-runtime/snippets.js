...
const GLOBAL_SNIPPET_DIR = path.join(CODEX_HOME, 'snippet');
const GLOBAL_SNIPPET_DIR_ALT = path.join(CODEX_HOME, 'snippets');
...
function getProjectSnippetDirs(workingDirectory) {
  ...
  return [
    path.join(workingDirectory, '.codex', 'snippets'),
    path.join(workingDirectory, '.codex', 'snippet'),
  ];
}
