...
const USER_MESSAGE_RENDERING_OPTIONS: Option<'markdown' | 'plain'>[] = [
    {
        id: 'markdown',
        label: 'appearance.userMarkdown',
        description: 'appearance.userMarkdowDesc',
    },
    {
        id: 'plain',
        label: 'appearance.userPlainText',
        description: 'appearance.userPlainTextDesc',
    },
];
...
export type VisibleSetting = 'language' | 'theme' | 'pwaInstallName' | 'fontSize' | 'terminalFontSize' | 'spacing' | 'cornerRadius' | 'inputBarOffset' | 'navRail' | 'toolOutput' | 'mermaidRendering' | 'userMessageRendering' | 'stickyUserHeader' | 'diffLayout' | 'mobileStatusBar' | 'dotfiles' | 'reasoning' | 'queueMode' | 'textJustificationActivity' | 'activityHeaderTimestamps' | 'terminalQuickKeys' | 'persistDraft' | 'inputSpellcheck';
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <Radio
                                                                ...
                                                                ariaLabel={t('appearance.userMessageRenderingOptionAria', { option: t(option.label) })}
                                                            />
