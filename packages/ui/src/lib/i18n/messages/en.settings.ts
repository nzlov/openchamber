export const settingsDict = {
  ...
  'settings.view.actions.reloadRuntime': 'Reload runtime',
  'settings.view.actions.reloadRuntimeTooltip': 'Restart the runtime and reload its configuration.',
  ...
  'settings.snippets.page.hint': 'Use #name in prompts. Supports aliases and prepend/append blocks compatible with codex-snippets.',
  ...
  'settings.agents.page.toast.savedManualRestart': 'Saved to disk. Restart the connected Codex runtime to apply the changes.',
  ...
  'settings.behavior.page.warning.description': 'Changes made here update {path}. Codex also includes any project-level AGENTS.md rules when they exist.',
  ...
  'settings.skills.location.option.userCodex.label': 'User / Codex',
  'settings.skills.location.option.userCodex.description': 'Global Codex config location',
  'settings.skills.location.option.projectCodex.label': 'Project / Codex',
  'settings.skills.location.option.projectCodex.description': 'Current project .codex location',
  ...
  'settings.plugins.toast.reloadFailed': 'codex reload failed — restart required',
  ...
  'settings.openchamber.worktrees.list.tooltip': 'Worktrees live outside the repo (Codex-managed). Deleting a worktree also removes linked sessions.',
  ...
  'settings.providers.sidebar.empty.description': 'Check your Codex configuration',
  ...
  'settings.providers.page.empty.checkCodexConfiguration': 'Check your Codex configuration',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to Codex and never stored by OpenChamber.',
  ...
  'settings.mcp.page.status.description.connected': 'Connected and ready for Codex to discover tools and resources.',
  'settings.mcp.page.status.description.failedDefault': 'Codex could not reach this MCP server.',
  ...
  'settings.mcp.page.auth.waitingForCodex': 'Waiting for Codex to observe the completed browser authorization flow...',
  ...
  'settings.mcp.page.advanced.timeoutHint': 'Leave blank to use Codex\'s default MCP timeout.',
  ...
  'settings.mcp.page.advanced.oauthHint': 'Leave these fields blank to let Codex infer OAuth settings from the MCP server.',
  ...
  'settings.mcp.page.env.plainTextWarning': '⚠ Values are stored as plain text in codex.json',
  ...
  'settings.mcp.page.deleteDialog.descriptionSuffix': 'Codex will need to reload.',
  ...
  'settings.mcp.page.toast.serverCreatedReloadFailed': 'MCP server created, but runtime reload failed.',
  'settings.mcp.page.toast.savedReloadFailed': 'Saved, but runtime reload failed.',
  'settings.mcp.page.toast.retryRefreshHint': 'Retry refresh or reopen Settings before authorizing this server.',
  'settings.mcp.page.toast.serverCreatedReloading': 'MCP server created. Runtime reloading…',
  'settings.mcp.page.toast.savedReloading': 'Saved. Runtime reloading…',
  'settings.mcp.page.toast.saveFailed': 'Failed to save',
  'settings.mcp.page.toast.unexpectedError': 'An error occurred',
  'settings.mcp.page.toast.serverDeletedReloadFailed': '"{name}" deleted, but runtime reload failed',
  ...
  'settings.mcp.page.toast.runtimeReloadFailedAfterCallbackSave': 'Runtime reload failed after saving the browser callback URL',
  ...
  'settings.openchamber.defaults.summaryCodexDefault': 'Codex agent default',
