...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.emptyState.codexUnreachable': 'Codex jest nieosiągalny',
  ...
  'onboarding.localSetup.title': 'Konfiguracja Codex',
  'onboarding.localSetup.description': 'Zainstaluj CLI Codex aby kontynuować.',
  'onboarding.localSetup.dialog.selectOpencodeBinary': 'Wybierz binarkę codex',
  'onboarding.localSetup.errors.cliNotReady': 'Codex CLI nie jest jeszcze gotowy. Potwierdź, że instalacja jest kompletna i spróbuj ponownie.',
  ...
  'onboarding.localSetup.windows.stepInstallWsl': 'Zainstaluj Codex za pomocą poniższego polecenia.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Jeśli OpenChamber nie wykryje Codex automatycznie, ustaw ścieżkę binarki poniżej.',
  'onboarding.localSetup.docs.windows': 'Dokumentacja Codex',
  'onboarding.localSetup.docs.default': 'Wyświetl dokumentację',
  'onboarding.localSetup.actions.checking': 'Sprawdzanie...',
  'onboarding.localSetup.helper.checkAndContinue': 'Kliknij aby sprawdzić czy Codex CLI jest dostępny. Jeśli się uda, automatycznie przejdziesz do głównego ekranu.',
  'onboarding.localSetup.field.alreadyInstalled': 'Juz zainstalowane? Ustaw ścieżkę binarki Codex:',
  'onboarding.localSetup.actions.browse': 'Przeglądaj',
  'onboarding.localSetup.actions.apply': 'Zastosuj',
  'onboarding.localSetup.helper.saveAndReload': 'Zapisuje do ustawień OpenChamber i przeładowuje konfigurację Codex.',
  ...
  'onboarding.localSetup.windows.hintInstallInWsl': 'W Windows zainstaluj i uruchom Codex natywnie.',
  'onboarding.localSetup.windows.hintDetectionFailed': 'Jeśli wykrywanie nie powiedzie się, ustaw natywną ścieżkę, np. codex.cmd lub codex.exe.',
  'onboarding.localSetup.hint.ensurePath': 'Juz zainstalowane? Upewnij się, że codex jest w twoim PATH.',
  'onboarding.localSetup.hint.setEnv': 'Lub ustaw zmienną środowiskową OPENCHAMBER_CODEX_BINARY.',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': 'Codex lokalny niedostępny',
  'onboarding.desktopRecovery.localUnavailable.description': 'Nie można było uruchomić Codex CLI lub nie jest zainstalowany. Zainstaluj Codex lub połącz się z serwerem zdalnym.',
  ...
  'aboutDialog.diagnosticsDescription': 'Zawiera stan OpenChamber, kondycję Codex, katalogi i projekty.',
  ...
  'codexUpdate.toast.available.title': 'Aktualizacja Codex',
  'codexUpdate.toast.available.description': 'Wersja {version} dostępna.',
  'codexUpdate.toast.actions.update': 'Aktualizuj',
  'codexUpdate.toast.actions.dismiss': 'Odrzuć',
  'codexUpdate.toast.actions.reload': 'Przeładuj Codex',
  'codexUpdate.toast.upgrading.title': 'Aktualizowanie Codex...',
  'codexUpdate.toast.upgrading.description': 'Pozostaw OpenChamber otwarte.',
  'codexUpdate.toast.updated.title': 'Codex zaktualizowany',
  'codexUpdate.toast.updated.description': 'Aktualizacja zainstalowana.',
  'codexUpdate.toast.updated.descriptionWithVersion': 'Wersja {version} zainstalowana.',
  'codexUpdate.toast.failed.title': 'Nie udało się zaktualizować Codex',
  'codexUpdate.toast.failed.description': 'Aktualizacja Codex nie powiodła się.',
  'codexUpdate.toast.reload.message': 'Ponowne uruchamianie Codex...',
  ...
  'onboarding.localSetup.intro': 'Codex to serce OpenChamber — zainstaluj je, aby zacząć.',
  'onboarding.localSetup.actions.checkNow': 'Sprawdź teraz',
  'onboarding.localSetup.status.watching': 'Czekanie na Codex',
