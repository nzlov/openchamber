...
export const dict: Record<I18nKey, string> = {
  ...
  'aboutDialog.diagnosticsDescription': '包含 OpenChamber 状态、Codex 健康信息、目录和项目。',
  ...
  'chat.emptyState.codexUnreachable': '无法连接 Codex',
  ...
  'onboarding.localSetup.title': '设置 Codex',
  'onboarding.localSetup.description': '安装 Codex CLI 以继续。',
  'onboarding.localSetup.dialog.selectOpencodeBinary': '选择 Codex 可执行文件',
  'onboarding.localSetup.errors.cliNotReady': 'Codex CLI 尚未就绪。请确认安装完成后重试。',
  'onboarding.localSetup.errors.detectionFailed': '检测失败',
  'onboarding.localSetup.windows.title': 'Windows 设置',
  'onboarding.localSetup.windows.stepInstallWsl': '使用下方命令安装 Codex。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 OpenChamber 未自动检测到 Codex，请在下方设置可执行文件路径。',
  'onboarding.localSetup.intro': 'Codex 是 OpenChamber 的核心，先安装它即可开始。',
  'onboarding.localSetup.docs.windows': 'Codex 文档',
  'onboarding.localSetup.docs.default': 'Codex 文档',
  ...
  'onboarding.localSetup.helper.checkAndContinue': '点击检测 Codex CLI 是否可用。成功后将自动进入主界面。',
  'onboarding.localSetup.status.watching': '正在等待 Codex',
  'onboarding.localSetup.status.autoContinue': '检测到后将自动继续。',
  'onboarding.localSetup.field.alreadyInstalled': '已安装？设置 Codex CLI 路径：',
  ...
  'onboarding.localSetup.helper.saveAndReload': '将保存到 OpenChamber 设置并重新加载 Codex 配置。',
  'onboarding.localSetup.remotePreference': '更希望使用远程服务器？',
  'onboarding.localSetup.actions.connectRemoteServer': '连接远程服务器 →',
  'onboarding.localSetup.windows.hintInstallInWsl': '在 Windows 上，请原生安装并运行 Codex。',
  'onboarding.localSetup.windows.hintDetectionFailed': '若检测失败，请设置原生路径，例如 codex.cmd 或 codex.exe。',
  'onboarding.localSetup.hint.ensurePath': '已安装？请确认 codex 在你的 PATH 中。',
  'onboarding.localSetup.hint.setEnv': '或设置 OPENCHAMBER_CODEX_BINARY 环境变量。',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': '本地 Codex 不可用',
  'onboarding.desktopRecovery.localUnavailable.description': 'Codex CLI 无法启动或未安装。请安装 Codex，或改为连接远程服务器。',
  ...
  'codexUpdate.toast.available.description': '版本 {version} 可用。',
  'codexUpdate.toast.actions.update': '更新',
  'codexUpdate.toast.actions.dismiss': '忽略',
  'codexUpdate.toast.actions.reload': '重载 Codex',
  'codexUpdate.toast.upgrading.title': '正在更新 Codex...',
  'codexUpdate.toast.upgrading.description': '请保持 OpenChamber 打开。',
  'codexUpdate.toast.updated.title': 'Codex 已更新',
  'codexUpdate.toast.updated.description': '更新已安装。',
  'codexUpdate.toast.updated.descriptionWithVersion': '版本 {version} 已安装。',
  'codexUpdate.toast.failed.title': '无法更新 Codex',
  'codexUpdate.toast.failed.description': 'Codex 升级失败。',
  'codexUpdate.toast.reload.message': '正在重启 Codex...',
