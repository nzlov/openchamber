...
export const dict: Record<I18nKey, string> = {
  ...
  'aboutDialog.diagnosticsDescription': 'OpenChamber 상태, Codex 상태, 디렉터리 및 프로젝트를 포함합니다.',
  ...
  'chat.emptyState.codexUnreachable': 'Codex에 연결할 수 없음',
  ...
  'onboarding.localSetup.title': 'Codex 설정',
  'onboarding.localSetup.description': '계속하려면 Codex CLI를 설치하세요.',
  'onboarding.localSetup.dialog.selectOpencodeBinary': 'codex 바이너리 선택',
  'onboarding.localSetup.errors.cliNotReady': 'Codex CLI가 아직 준비되지 않았습니다. 설치가 완료되었는지 확인하고 다시 시도하세요.',
  'onboarding.localSetup.errors.detectionFailed': '감지에 실패했습니다',
  'onboarding.localSetup.windows.title': 'Windows 설정',
  'onboarding.localSetup.windows.stepInstallWsl': '아래 명령으로 Codex를 설치하세요.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'OpenChamber가 Codex를 자동으로 찾지 못하면 아래에 바이너리 경로를 설정하세요.',
  'onboarding.localSetup.intro': 'Codex는 OpenChamber의 심장입니다. 먼저 설치하고 시작하세요.',
  'onboarding.localSetup.docs.windows': 'Codex 문서',
  'onboarding.localSetup.docs.default': 'Codex 문서',
  ...
  'onboarding.localSetup.helper.checkAndContinue': 'Codex CLI를 사용할 수 있으면 확인을 누르세요. 성공하면 자동으로 메인 화면으로 이동합니다.',
  'onboarding.localSetup.status.watching': 'Codex 대기 중',
  'onboarding.localSetup.status.autoContinue': '감지되면 자동으로 계속됩니다.',
  'onboarding.localSetup.field.alreadyInstalled': '이미 설치되어 있나요? Codex CLI 경로 설정:',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'OpenChamber 설정에 저장하고 Codex 구성을 다시 로드합니다.',
  'onboarding.localSetup.remotePreference': '원격 서버를 사용하시겠어요?',
  'onboarding.localSetup.actions.connectRemoteServer': '리모트 서버 연결 →',
  'onboarding.localSetup.windows.hintInstallInWsl': 'Windows에서는 Codex를 네이티브로 설치하고 실행하세요.',
  'onboarding.localSetup.windows.hintDetectionFailed': '감지에 실패하면 codex.cmd 또는 codex.exe 같은 네이티브 경로를 설정하세요.',
  'onboarding.localSetup.hint.ensurePath': '이미 설치되어 있나요? codex가 PATH에 있는지 확인하세요.',
  'onboarding.localSetup.hint.setEnv': '또는 `OPENCHAMBER_CODEX_BINARY` 환경 변수를 설정하세요.',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': '로컬 Codex를 사용할 수 없음',
  'onboarding.desktopRecovery.localUnavailable.description': 'Codex CLI를 시작할 수 없거나 설치되어 있지 않습니다. Codex를 설치하거나 원격 서버에 연결하세요.',
  ...
  'codexUpdate.toast.available.title': 'Codex 업데이트',
  'codexUpdate.toast.available.description': '버전 {version} 사용 가능.',
  'codexUpdate.toast.actions.update': '업데이트',
  'codexUpdate.toast.actions.dismiss': '닫기',
  'codexUpdate.toast.actions.reload': 'Codex 다시 로드',
  'codexUpdate.toast.upgrading.title': 'Codex 업데이트 중...',
  'codexUpdate.toast.upgrading.description': 'OpenChamber를 열어 두세요.',
  'codexUpdate.toast.updated.title': 'Codex 업데이트 완료',
  'codexUpdate.toast.updated.description': '업데이트가 설치되었습니다.',
  'codexUpdate.toast.updated.descriptionWithVersion': '버전 {version}이 설치되었습니다.',
  'codexUpdate.toast.failed.title': 'Codex를 업데이트할 수 없음',
  'codexUpdate.toast.failed.description': 'Codex 업그레이드에 실패했습니다.',
  'codexUpdate.toast.reload.message': 'Codex 다시 시작 중...',
