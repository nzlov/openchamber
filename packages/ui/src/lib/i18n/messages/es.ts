...
export const dict: Record<I18nKey, string> = {
  ...
  "aboutDialog.diagnosticsDescription": "Incluye el estado de OpenChamber, el estado de Codex, directorios y proyectos.",
  ...
  "chat.emptyState.codexUnreachable": "Codex no es accesible",
  ...
  "onboarding.localSetup.title": "Configuración de Codex",
  "onboarding.localSetup.description": "Instala la CLI de Codex para continuar.",
  "onboarding.localSetup.dialog.selectOpencodeBinary": "Seleccionar ejecutable de codex",
  "onboarding.localSetup.errors.cliNotReady": "La CLI de Codex aún no está lista. Confirma que la instalación está completa y intenta de nuevo.",
  ...
  "onboarding.localSetup.windows.stepInstallWsl": "Instala Codex con el comando siguiente.",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Si OpenChamber no detecta Codex automáticamente, establece la ruta del ejecutable a continuación.",
  "onboarding.localSetup.intro": "Codex es el corazón de OpenChamber. Instálalo para empezar.",
  "onboarding.localSetup.docs.windows": "Documentación de Codex",
  "onboarding.localSetup.docs.default": "Documentación de Codex",
  ...
  "onboarding.localSetup.helper.checkAndContinue": "Haz clic para verificar si la CLI de Codex está disponible. Si la verificación funciona, entrarás automáticamente en la pantalla principal.",
  "onboarding.localSetup.status.watching": "Esperando Codex",
  "onboarding.localSetup.status.autoContinue": "Continuaremos automáticamente al detectarlo.",
  "onboarding.localSetup.field.alreadyInstalled": "¿Ya está instalado? Establece la ruta de la CLI de Codex:",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Guarda en la configuración de OpenChamber y recarga la configuración de Codex.",
  ...
  "onboarding.localSetup.windows.hintInstallInWsl": "En Windows, instala y ejecuta Codex de forma nativa.",
  "onboarding.localSetup.windows.hintDetectionFailed": "Si la detección falla, establece una ruta nativa como codex.cmd u codex.exe.",
  "onboarding.localSetup.hint.ensurePath": "¿Ya está instalado? Asegúrate de que codex esté en tu PATH.",
  "onboarding.localSetup.hint.setEnv": "O establece la variable de entorno OPENCHAMBER_CODEX_BINARY.",
  ...
  "onboarding.desktopRecovery.localUnavailable.title": "Codex Local no disponible",
  "onboarding.desktopRecovery.localUnavailable.description": "La CLI de Codex no pudo iniciarse o no está instalado. Instala Codex o conecta a un servidor remoto en su lugar.",
  ...
  "codexUpdate.toast.available.title": "Actualización de Codex",
  "codexUpdate.toast.available.description": "Versión {version} disponible.",
  "codexUpdate.toast.actions.update": "Actualizar",
  "codexUpdate.toast.actions.dismiss": "Descartar",
  "codexUpdate.toast.actions.reload": "Recargar Codex",
  "codexUpdate.toast.upgrading.title": "Actualizando Codex...",
  "codexUpdate.toast.upgrading.description": "Mantén OpenChamber abierto.",
  "codexUpdate.toast.updated.title": "Codex actualizado",
  "codexUpdate.toast.updated.description": "Actualización instalada.",
  "codexUpdate.toast.updated.descriptionWithVersion": "Versión {version} instalada.",
  "codexUpdate.toast.failed.title": "No se pudo actualizar Codex",
  "codexUpdate.toast.failed.description": "La actualización de Codex falló.",
  "codexUpdate.toast.reload.message": "Reiniciando Codex...",
