...
export const dict = {
  ...
  'aboutDialog.diagnosticsDescription': 'Includes OpenChamber state, Codex health, directories, and projects.',
  ...
  'chat.emptyState.codexUnreachable': 'Codex is not reachable',
  ...
  'onboarding.localSetup.title': 'Setting Up Codex',
  'onboarding.localSetup.description': 'Install Codex CLI to continue.',
  'onboarding.localSetup.dialog.selectOpencodeBinary': 'Select codex binary',
  'onboarding.localSetup.errors.cliNotReady': 'Codex CLI is not ready yet. Please confirm installation is complete and try again.',
  'onboarding.localSetup.errors.detectionFailed': 'Detection failed',
  'onboarding.localSetup.windows.title': 'Windows setup',
  'onboarding.localSetup.windows.stepInstallWsl': 'Install Codex with the command below.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If OpenChamber does not detect Codex automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'Codex is the heart of OpenChamber — install it to get started.',
  'onboarding.localSetup.docs.windows': 'Codex docs',
  'onboarding.localSetup.docs.default': 'Codex docs',
  ...
  'onboarding.localSetup.helper.checkAndContinue': 'Click to check if Codex CLI is available. If successful, you\'ll automatically enter the main screen.',
  'onboarding.localSetup.status.watching': 'Waiting for Codex',
  'onboarding.localSetup.status.autoContinue': "We'll continue automatically once it's detected.",
  'onboarding.localSetup.field.alreadyInstalled': 'Already installed? Set the Codex CLI path:',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to OpenChamber settings and reloads Codex configuration.',
  ...
  'onboarding.localSetup.windows.hintInstallInWsl': 'On Windows, install and run Codex natively.',
  'onboarding.localSetup.windows.hintDetectionFailed': 'If detection fails, set a native path such as codex.cmd or codex.exe.',
  'onboarding.localSetup.hint.ensurePath': 'Already installed? Make sure codex is in your PATH.',
  'onboarding.localSetup.hint.setEnv': 'Or set OPENCHAMBER_CODEX_BINARY environment variable.',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': 'Local Codex Unavailable',
  'onboarding.desktopRecovery.localUnavailable.description': 'Codex CLI could not be started or is not installed. Install Codex or connect to a remote server instead.',
  ...
  'codexUpdate.toast.available.title': 'Codex update',
  'codexUpdate.toast.available.description': 'Version {version} available.',
  'codexUpdate.toast.actions.update': 'Update',
  'codexUpdate.toast.actions.dismiss': 'Dismiss',
  'codexUpdate.toast.actions.reload': 'Reload Codex',
  'codexUpdate.toast.upgrading.title': 'Updating Codex...',
  'codexUpdate.toast.upgrading.description': 'Keep OpenChamber open.',
  'codexUpdate.toast.updated.title': 'Codex updated',
  'codexUpdate.toast.updated.description': 'Update installed.',
  'codexUpdate.toast.updated.descriptionWithVersion': 'Version {version} installed.',
  'codexUpdate.toast.failed.title': 'Could not update Codex',
  'codexUpdate.toast.failed.description': 'The Codex upgrade failed.',
  'codexUpdate.toast.reload.message': 'Restarting Codex...',
