...
export const dict: Record<I18nKey, string> = {
  ...
  "aboutDialog.diagnosticsDescription": "Inclui o estado do OpenChamber, a integridade do Codex, diretórios e projetos.",
  ...
  "chat.emptyState.codexUnreachable": "Codex não está acessível",
  ...
  "onboarding.localSetup.title": "Configuração do Codex",
  "onboarding.localSetup.description": "Instale a CLI do Codex para continuar.",
  "onboarding.localSetup.dialog.selectOpencodeBinary": "Selecionar executável de codex",
  "onboarding.localSetup.errors.cliNotReady": "A CLI do Codex ainda não está pronta. Confirme que a instalação está completa e tente novamente.",
  "onboarding.localSetup.errors.detectionFailed": "Erro de detecção",
  "onboarding.localSetup.windows.title": "Configuração no Windows",
  "onboarding.localSetup.windows.stepInstallWsl": "Instale o Codex com o comando abaixo.",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Se o OpenChamber não detectar o Codex automaticamente, defina o caminho do executável a seguir.",
  "onboarding.localSetup.intro": "Codex é o coração do OpenChamber. Instale-o para começar.",
  "onboarding.localSetup.docs.windows": "Documentação do Codex",
  "onboarding.localSetup.docs.default": "Documentação do Codex",
  ...
  "onboarding.localSetup.helper.checkAndContinue": "Clique para verificar se a CLI do Codex está disponível. Se a verificação funcionar, você entrará automaticamente na tela principal.",
  "onboarding.localSetup.status.watching": "Aguardando Codex",
  "onboarding.localSetup.status.autoContinue": "Continuaremos automaticamente assim que detectado.",
  "onboarding.localSetup.field.alreadyInstalled": "Já está instalado? Defina o caminho da CLI do Codex:",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Salve nas configurações do OpenChamber e recarregue configurações do Codex.",
  ...
  "onboarding.localSetup.windows.hintInstallInWsl": "No Windows, instale e execute o Codex nativamente.",
  "onboarding.localSetup.windows.hintDetectionFailed": "Se a detecção falhar, defina um caminho nativo, como codex.cmd ou codex.exe.",
  "onboarding.localSetup.hint.ensurePath": "Já está instalado? Confira se codex está no seu PATH.",
  "onboarding.localSetup.hint.setEnv": "Ou defina a variável de ambiente OPENCHAMBER_CODEX_BINARY.",
  ...
  "onboarding.desktopRecovery.localUnavailable.title": "Codex Local não disponível",
  "onboarding.desktopRecovery.localUnavailable.description": "A CLI do Codex não pôde ser iniciada ou não está instalada. Instale o Codex ou conecte um servidor remoto no lugar dela.",
  ...
  "codexUpdate.toast.available.title": "Atualização do Codex",
  "codexUpdate.toast.available.description": "Versão {version} disponível.",
  "codexUpdate.toast.actions.update": "Atualizar",
  "codexUpdate.toast.actions.dismiss": "Dispensar",
  "codexUpdate.toast.actions.reload": "Recarregar Codex",
  "codexUpdate.toast.upgrading.title": "Atualizando Codex...",
  "codexUpdate.toast.upgrading.description": "Mantenha o OpenChamber aberto.",
  "codexUpdate.toast.updated.title": "Codex atualizado",
  "codexUpdate.toast.updated.description": "Atualização instalada.",
  "codexUpdate.toast.updated.descriptionWithVersion": "Versão {version} instalada.",
  "codexUpdate.toast.failed.title": "Não foi possível atualizar o Codex",
  "codexUpdate.toast.failed.description": "A atualização do Codex falhou.",
