...
export const dict: Record<I18nKey, string> = {
  ...
  'aboutDialog.diagnosticsDescription': '包含 OpenChamber 狀態、Codex 健康資訊、目錄和專案。',
  ...
  'chat.emptyState.codexUnreachable': '無法連線 Codex',
  ...
  'onboarding.localSetup.title': '設定 Codex',
  'onboarding.localSetup.description': '安裝 Codex CLI 以繼續。',
  'onboarding.localSetup.dialog.selectOpencodeBinary': '選擇 Codex 執行檔',
  'onboarding.localSetup.errors.cliNotReady': 'Codex CLI 尚未就緒。請確認安裝完成後重試。',
  'onboarding.localSetup.errors.detectionFailed': '偵測失敗',
  'onboarding.localSetup.windows.title': 'Windows 設定',
  'onboarding.localSetup.windows.stepInstallWsl': '使用下方命令安裝 Codex。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 OpenChamber 未自動偵測到 Codex，請在下方設定執行檔路徑。',
  'onboarding.localSetup.intro': 'Codex 是 OpenChamber 的核心，先安裝它即可開始。',
  'onboarding.localSetup.docs.windows': 'Codex 文件',
  'onboarding.localSetup.docs.default': 'Codex 文件',
  ...
  'onboarding.localSetup.helper.checkAndContinue': '點擊偵測 Codex CLI 是否可用。成功後將自動進入主介面。',
  'onboarding.localSetup.status.watching': '正在等待 Codex',
  'onboarding.localSetup.status.autoContinue': '偵測到後將自動繼續。',
  'onboarding.localSetup.field.alreadyInstalled': '已安裝？設定 Codex CLI 路徑：',
  ...
  'onboarding.localSetup.helper.saveAndReload': '將儲存到 OpenChamber 設定並重新載入 Codex 設定。',
  'onboarding.localSetup.remotePreference': '更希望使用遠端伺服器？',
  'onboarding.localSetup.actions.connectRemoteServer': '連接遠端伺服器 →',
  'onboarding.localSetup.windows.hintInstallInWsl': '在 Windows 上，請原生安裝並執行 Codex。',
  'onboarding.localSetup.windows.hintDetectionFailed': '若偵測失敗，請設定原生路徑，例如 codex.cmd 或 codex.exe。',
  'onboarding.localSetup.hint.ensurePath': '已安裝？請確認 codex 在你的 PATH 中。',
  'onboarding.localSetup.hint.setEnv': '或設定 OPENCHAMBER_CODEX_BINARY 環境變數。',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': '本地 Codex 無法使用',
  'onboarding.desktopRecovery.localUnavailable.description': 'Codex CLI 無法啟動或未安裝。請安裝 Codex，或改為連接遠端伺服器。',
  ...
  'codexUpdate.toast.available.title': 'Codex 更新',
  'codexUpdate.toast.available.description': '版本 {version} 可安裝。',
  'codexUpdate.toast.actions.update': '更新',
  'codexUpdate.toast.actions.dismiss': '忽略',
  'codexUpdate.toast.actions.reload': '重新載入 Codex',
  'codexUpdate.toast.upgrading.title': '正在更新 Codex...',
  'codexUpdate.toast.upgrading.description': '請保持 OpenChamber 開啟。',
  'codexUpdate.toast.updated.title': 'Codex 已更新',
  'codexUpdate.toast.updated.description': '更新已安裝。',
  'codexUpdate.toast.updated.descriptionWithVersion': '版本 {version} 已安裝。',
  'codexUpdate.toast.failed.title': '無法更新 Codex',
  'codexUpdate.toast.failed.description': 'Codex 升級失敗。',
  'codexUpdate.toast.reload.message': '正在重新啟動 Codex...',
